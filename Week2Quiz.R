...
# Set the 'fig.height' and 'fig.width' options for the code chunk CORRECT ANSWER

4 # With some code chunks, we may not want the output generated by the chunk to be rendered into 
  # HTML but would prefer to print the output verbatim. How can we specify this preference for a 
  # given code chunk?

# Set the option \verb|tidy = FALSE|tidy=FALSE
# Set the option \verb|highlight = TRUE|highlight=TRUE
# Set the option \verb|results = "asis"|results="asis" CORRECT ANSWER
# Set the option \verb|message = FALSE|message=FALSE

5 # When using knitr and R Markdown and producing output in HTML, why should you never edit the 
  # resulting HTML file?

# The Markdown file generated by knitr is the appropriate file to edit.
# The HTML file is not a text file.
# Every time you knit() the R Markdown file, the HTML file will be overwritten CORRECT ANSWER
